...
class ChatCompletionAssistantMessageParam(BaseModel):
    ...
    prefix: Optional[bool] = Field(
        False,
        description="Users provide an assistant's prefix message for the model to complete the rest of the message. https://api-docs.deepseek.com/guides/chat_prefix_completion",
    )
